...
$routes->group('api', function($routes){
    ...
    $routes->get('riwayat','Peminjaman::riwayat', ['filter' => 'auth']);    
    $routes->post('peminjaman/pinjam','Peminjaman::pinjam', ['filter' => 'auth']);
    $routes->post('peminjaman/validasi','Peminjaman::validasiPengembalian', ['filter' => 'auth']);
    $routes->get('peminjaman/riwayat','Peminjaman::riwayat', ['filter' => 'auth']);
    $route
});